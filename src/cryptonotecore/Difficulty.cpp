...
inline float calculateDifficultyResetMultiplier(
...
uint64_t adjustForDifficultyReset(const uint64_t nextDifficulty, const uint64_t blockIndex)
{
                            ...
                            + CryptoNote::parameters::DIFFICULTY_RESET_WINDOW_V1)
    {
        ...
        float currrentDifficultyMultiplier = calculateDifficultyResetMultiplier(
            blockIndex,
        ...
        return (uint64_t)nextDifficulty * currrentDifficultyMultiplier;
    }
